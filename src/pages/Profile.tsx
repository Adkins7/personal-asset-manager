    ...
    <div className="max-w-2xl mx-auto space-y-8">
      ...
      <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100 flex items-center gap-6">
        ...
        <div>
          ...
          <p className="text-gray-500 text-sm">已通过邮箱验证</p>
          <div className="mt-2 flex items-center gap-2 text-xs text-emerald-600 font-medium bg-emerald-50 px-2 py-1 rounded-full w-fit">
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
        <div className="p-6 border-b border-gray-100 bg-gray-50">
          <h3 className="font-bold text-gray-900">数据备份与恢复</h3>
          <p className="text-sm text-gray-500 mt-1">导出您的所有数据以供备份，或从备份文件中恢复。</p>
        </div>
        <div className="p-8 grid grid-cols-1 md:grid-cols-2 gap-6">
          <button
            onClick={handleBackup}
            disabled={loading}
            className="flex flex-col items-center justify-center p-6 border-2 border-dashed border-gray-200 rounded-xl hover:border-emerald-500 hover:bg-emerald-50 transition-all group"
          >
            <Download className="w-8 h-8 text-gray-400 group-hover:text-emerald-600 mb-2" />
            <span className="font-medium text-gray-700 group-hover:text-emerald-700">立即备份</span>
            <span className="text-xs text-gray-400 mt-1">下载 JSON 格式数据</span>
          </button>

          <label className="flex flex-col items-center justify-center p-6 border-2 border-dashed border-gray-200 rounded-xl hover:border-blue-500 hover:bg-blue-50 transition-all group cursor-pointer">
            ...
            <span className="font-medium text-gray-700 group-hover:text-blue-700">恢复数据</span>
            <span className="text-xs text-gray-400 mt-1">上传备份的 JSON 文件</span>
          </label>
        </div>
      </div>
      ...
      <div className="bg-amber-50 p-6 rounded-xl border border-amber-100 flex gap-4">
        ...
        <div>
          <h4 className="font-bold text-amber-900 text-sm">安全提示</h4>
      ...
      <button
        onClick={signOut}
        className="w-full flex items-center justify-center gap-2 py-3 border border-red-200 text-red-600 rounded-xl font-medium hover:bg-red-50 transition-colors"
      >
